...
class Details extends StatelessWidget {
  ...
  Image _buildJournalHeaderImage(){
    return Image(image: AssetImage('images/Pizza1.jpg'),
    fit: BoxFit.cover,
    );
  }
  ...
  Row _buildJournalFooterImages(){
    return Row(
      ...
      children: <Widget>[CircleAvatar(backgroundImage: AssetImage('images/Pizza2.jpg'),
      radius: 40.0,
      ),
      CircleAvatar(backgroundImage: AssetImage('images/Pizza3.jpg'),
       radius: 40.0,
      ),
      CircleAvatar(backgroundImage: AssetImage('images/Pizza4.jpg'),
       radius: 40.0,
      ),
      SizedBox(
        width:100.0,
