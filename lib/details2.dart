...
class Details2 extends StatelessWidget {
  ...
  const Details2({Key key, this.imageUrl})  : super(key: key);
  @override
  ...
  Image _buildJournalHeaderImage(){
    return Image(image: AssetImage('images/Pancake1.jpg'),
    fit: BoxFit.cover,
    );
  }
  ...
  Row _buildJournalFooterImages(){
    return Row(
      ...
      children: <Widget>[CircleAvatar(backgroundImage: AssetImage('images/Pancake2.jpg'),
      radius: 40.0,
      ),
      CircleAvatar(backgroundImage: AssetImage('images/Pancake3.jpg'),
       radius: 40.0,
      ),
      CircleAvatar(backgroundImage: AssetImage('images/Pancake4.jpg'),
       radius: 40.0,
      ),
      SizedBox(
        width:100.0,
